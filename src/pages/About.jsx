      ...
      <div className="grid md:grid-cols-2 gap-10 items-center mt-14">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-4">
            At Fashion & Future Institute, we believe that fashion is more than
            clothing—it’s a powerful form of expression, innovation, and cultural
            dialogue.
          </p>
          <p className="text-gray-600 mb-4">
            Our mission is to empower aspiring designers with the skills, vision,
            and industry connections they need to shape the future of fashion.
          </p>
